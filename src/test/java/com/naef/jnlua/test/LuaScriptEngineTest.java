...
public class LuaScriptEngineTest {
     ...
     */
    @Test
    public void testScriptEngineFactory() throws Throwable {
        setup();
        // Get factory
        ...
        // getMethodCallSyntax()
        assertEquals("process:execute(a, b)", factory.getMethodCallSyntax("process", "execute", "a", "b"));

        // getOutputStatement()
        assertEquals("print(\"test\")", factory.getOutputStatement("test"));
        assertEquals("print(\"\\\"quoted\\\"\")", factory.getOutputStatement("\"quoted\""));

        // getProgram()
        assertEquals("a = 1\nreturn b\n", factory.getProgram("a = 1", "return b"));
    }
    ...
    public void testScriptEngine() throws Exception {
        ...
        assertEquals("test2", scriptEngine.eval(new StringReader("return t"), bindings));
        ...
        assertSame(bindings, scriptEngine.getBindings(ScriptContext.ENGINE_SCOPE));
        ...
        assertSame(context.getErrorWriter(), scriptEngine.eval("return errorWriter"));
    ...
    public void testCompilable() throws Exception {
        ...
        scriptContext.setAttribute("t", Double.valueOf(3.0), ScriptContext.GLOBAL_SCOPE);
