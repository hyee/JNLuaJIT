...
public interface Accessor<ANY> {
    ...
    <T> T get(ANY instance, int fieldIndex);
     ...
     */
    default Class<ANY> returnedClass() {
        return (Class<ANY>) getTypeArguments(Accessor.class, getClass()).get(0);
    }
     ...
     */
    static <T> List<Class<?>> getTypeArguments(
