...
![JNLua Architecture](../docs_old/Architecture.png)
...
Documentation is provided in the [wiki](https://github.com/airminer/jnlua/wiki) as well as in the form of generated Javadoc.
